...
export default function Loja() {
  ...
  function precoProduto(produto, variacao = null) {
    if (produtoTemVariacoes(produto) && variacao) {
      return Number(variacao.price || produto?.price || 0);
    }
  ...
  function precoCardProduto(produto) {
    ...
    const precos = variacoesProduto(produto)
...
${dados.description}`;
  ...
  async function salvarSolicitacao(e) {
    ...
    try {
      ...
      const mensagem = montarMensagemWhatsApp(produtoSelecionado, dadosSolicitacao, variacaoFinal);
